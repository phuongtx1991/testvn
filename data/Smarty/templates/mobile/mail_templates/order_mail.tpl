...
仕事コード：<!--{$arrOrderDetail[cnt].product_code}-->
仕事名：<!--{$arrOrderDetail[cnt].product_name}--> <!--{$arrOrderDetail[cnt].classcategory_name1}--> <!--{$arrOrderDetail[cnt].classcategory_name2}-->
...
仕事コード：<!--{$item.product_code}-->
仕事名：<!--{$item.product_name}--> <!--{$item.classcategory_name1}--> <!--{$item.classcategory_name2}-->
