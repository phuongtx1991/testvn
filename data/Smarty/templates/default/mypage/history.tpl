...
<div id="mypagecolumn">
    ...
    <div id="mycontents_area">
        ...
        <div class="mycondition_area clearfix">
            <p>
                ...
                <!--{if $is_price_change == true}-->
                    <div class="attention" Align="right">※金額が変更されている仕事があるため、再注文時はご注意ください。</div>
                <!--{/if}-->
            </p>
        ...
        <table summary="購入仕事詳細">
            ...
            <col width="15%" />
            <tr>
                <th class="alignC">仕事コード</th>
                <th class="alignC">仕事名</th>
                <th class="alignC">仕事種別</th>
                ...
                <table summary="お届け内容確認">
                    ...
                    <!--{foreach item=item from=$shippingItem.shipment_item}-->
                        <tr>
                            ...
                            <td><!--{* 仕事名 *}--><!--{$item.productsClass.name|h}--><br />
