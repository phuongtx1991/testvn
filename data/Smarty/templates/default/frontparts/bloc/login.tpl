                ...
                <div class="block_body">
                    <!--{if $tpl_login}-->
                        ...
                        <!--{if !$tpl_disable_logout}-->
                            <p class="btn">
                                <input type="image" class="hover_change_image" src="<!--{$TPL_URLPATH}-->img/button/btn_bloc_logout.jpg" onclick="eccube.fnFormModeSubmit('login_form', 'logout', '', ''); return false;" alt="Đăng xuất" />
                            </p>
                        <!--{/if}-->
                    <!--{else}-->
                        <dl class="formlist">
                            ...
                            <dd class="mini">
                                ...
                                <label for="login_memory"><span>Cho phép máy tính lưu địa chỉ email.</span></label>
                            </dd>
                        </dl>
                        <dl class="formlist">
                            <dt class="password">Mật khẩu</dt>
