        ...
        <!--{if $smarty.const.USE_POINT !== false || count($arrProductsClass) > 0}-->
            ...
            <!--{if $smarty.const.USE_POINT !== false}-->
                <div class="point_announce">
                    ...
                    <!--{/if}-->
                    ポイントは仕事購入時に<span class="price">1pt＝<!--{$smarty.const.POINT_VALUE|h}-->円</span>として使用することができます。<br />
                </div>
            <!--{/if}-->
        <!--{/if}-->
            ...
            <!--{foreach from=$cartKeys item=key}-->
                <div class="form_area">
                    <form name="form<!--{$key|h}-->" id="form<!--{$key|h}-->" method="post" action="?">
                        ...
                        <!--{else}-->
                            <!--{assign var=purchasing_goods_name value="カゴの中の仕事"}-->
                        <!--{/if}-->
                        <p>
                        ...
                        <table summary="仕事情報">
                            ...
                            <!--{foreach from=$cartItems[$key] item=item}-->
                                <tr style="<!--{if $item.error}-->background-color: <!--{$smarty.const.ERR_COLOR|h}-->;<!--{/if}-->">
                                    ...
                                    <td><!--{* 仕事名 *}--><strong><!--{$item.productsClass.name|h}--></strong>
