    ...
    <div id="complete">
        ...
        <div class="btn-area">
            <ul>
                ...
                <li><a class="btn-action" href="?" onclick="eccube.setModeAndSubmit('pre_edit', 'product_id', '<!--{$arrForm.product_id}-->'); return false;"><span class="btn-next">この求人の規格を登録する</span></a></li>
                <!--{/if}-->
            </ul>
        </div>
