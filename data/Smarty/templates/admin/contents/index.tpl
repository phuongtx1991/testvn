        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <!--{if $arrErr.news_title_vn}--><span class="attention"><!--{$arrErr.news_title_vn}--></span><!--{/if}-->
                    <textarea name="news_title" cols="60" rows="8" class="area60 top" maxlength="<!--{$smarty.const.MTEXT_LEN}-->" <!--{if $arrErr.news_title}-->style="background-color:<!--{$smarty.const.ERR_COLOR|h}-->"<!--{/if}-->><!--{"\n"}--><!--{$arrForm.news_title.value|h}--></textarea><br />
                    <textarea name="news_title_vn" cols="60" rows="8" class="area60 vn_field" maxlength="<!--{$smarty.const.MTEXT_LEN}-->" <!--{if $arrErr.news_title_vn}-->style="background-color:<!--{$smarty.const.ERR_COLOR|h}-->"<!--{/if}-->><!--{"\n"}--><!--{$arrForm.news_title_vn.value|h}--></textarea><br />
            ...
            <tr>
                ...
                <td>
                    ...
                    <!--{if $arrErr.news_comment_vn}--><span class="attention"><!--{$arrErr.news_comment_vn}--></span><!--{/if}-->
                    <textarea name="news_comment" cols="60" rows="8" wrap="soft" class="area60 top" maxlength="<!--{$smarty.const.LTEXT_LEN}-->" style="background-color:<!--{if $arrErr.news_comment}--><!--{$smarty.const.ERR_COLOR|h}--><!--{/if}-->"><!--{"\n"}--><!--{$arrForm.news_comment.value|h}--></textarea><br />
                    <textarea name="news_comment_vn" cols="60" rows="8" wrap="soft" class="area60 vn_field" maxlength="<!--{$smarty.const.LTEXT_LEN}-->" style="background-color:<!--{if $arrErr.news_comment_vn}--><!--{$smarty.const.ERR_COLOR|h}--><!--{/if}-->"><!--{"\n"}--><!--{$arrForm.news_comment_vn.value|h}--></textarea><br />
