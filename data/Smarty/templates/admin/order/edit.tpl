    ...
    <div id="order" class="contents-main">
        ...
        <h2 id="order_products">
            ...
            <!--{if $tpl_shipping_quantity <= 1}-->
                <a class="btn-normal" href="javascript:;" name="add_product" onclick="eccube.openWindow('<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->order/product_select.php?order_id=<!--{$arrForm.order_id.value|h}-->&amp;shipping_id=<!--{$top_shipping_id}-->', 'search', '615', '500', {menubar:'no'}); return false;">求人の追加</a>
            <!--{/if}-->
        </h2>
        ...
        <!--{foreach name=shipping from=$arrAllShipping item=arrShipping key=shipping_index}-->
            ...
            <!--{if $tpl_shipping_quantity > 1}-->
                <h2>届け先求人情報&nbsp;<a class="btn-normal" href="javascript:;" name="add_product" onclick="eccube.openWindow('<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->order/product_select.php?order_id=<!--{$arrForm.order_id.value|h}-->&shipping_id=<!--{$shipping_index}-->', 'search', '615', '500', {menubar:'no'}); return false;">求人の追加</a>
                </h2>
