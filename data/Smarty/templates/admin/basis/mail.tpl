        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <!--{assign var=key1 value="subject_vn"}-->
                    <!--{if $arrErr[$key] || $arrErr[$key1]}-->
                    <span class="attention"><!--{$arrErr[$key]}--><!--{$arrErr[$key1]}--></span>
                    <!--{/if}-->
                    <input type="text" name="subject" value="<!--{$arrForm[$key]|h}-->" onChange="setFlag();" size="30" class="box30 top" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" /><br />
                    <input type="text" name="subject_vn" value="<!--{$arrForm[$key1]|h}-->" onChange="setFlag();" size="30" class="box30 vn_field" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->" />
                </td>
            </tr>
            <tr>
                <th>ヘッダー</th>
                <td>
                    ...
                    <!--{assign var=key1 value="header_vn"}-->
                    <!--{if $arrErr[$key] || $arrErr[$key1]}-->
                    <span class="attention"><!--{$arrErr[$key]}--><!--{$arrErr[$key1]}--></span>
                    <!--{/if}-->
                    ...
                    <textarea name="header_vn" cols="75" rows="12" class="area75 vn_field" onChange="setFlag();" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->"><!--{"\n"}--><!--{$arrForm[$key1]|h}--></textarea><br />
                    <span class="attention"> (上限<!--{$smarty.const.LTEXT_LEN}-->文字)</span>
                    <div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <!--{assign var=key1 value="footer_vn"}-->
                    <!--{if $arrErr[$key] || $arrErr[$key1]}-->
                    <span class="attention"><!--{$arrErr[$key]}--><!--{$arrErr[$key1]}--></span>
                    <!--{/if}-->
                    ...
                    <textarea name="footer_vn" cols="75" rows="12" class="area75 vn_field" onChange="setFlag();" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->"><!--{"\n"}--><!--{$arrForm[$key1]|h}--></textarea><br />
                    <span class="attention"> (上限<!--{$smarty.const.LTEXT_LEN}-->文字)</span>
                    <div>
