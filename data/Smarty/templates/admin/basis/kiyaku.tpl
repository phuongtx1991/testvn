        ...
        <table class="form">
            <tr>
                ...
                <td>
                    ...
                    <span class="attention"><!--{$arrErr.kiyaku_title_vn}--></span>
                    <span class="attention"><!--{$arrErr.name}--></span>
                    <input type="text" name="kiyaku_title" value="<!--{$arrForm.kiyaku_title.value|h}-->" maxlength="<!--{$smarty.const.SMTEXT_LEN}-->" style="<!--{if $arrErr.kiyaku_title != "" || $arrErr.name != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60 top"/>
                    <span class="attention"> (上限<!--{$smarty.const.SMTEXT_LEN}-->文字)</span>
                    <br />
                    <input type="text" name="kiyaku_title_vn" value="<!--{$arrForm.kiyaku_title_vn.value|h}-->" maxlength="<!--{$smarty.const.SMTEXT_LEN}-->" style="<!--{if $arrErr.kiyaku_title_vn != "" || $arrErr.name != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" size="60" class="box60 vn_field"/>
                    <span class="attention"> (上限<!--{$smarty.const.SMTEXT_LEN}-->文字)</span>
                </td>
            </tr>
            <tr>
                ...
                <span class="attention"><!--{$arrErr.kiyaku_text_vn}--></span>
                <textarea name="kiyaku_text" maxlength="<!--{$smarty.const.LTEXT_LEN}-->" cols="60" rows="8" class="area60 top" style="<!--{if $arrErr.kiyaku_text != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" ><!--{"\n"}--><!--{$arrForm.kiyaku_text.value|h}--></textarea>
                <span class="attention"> (上限<!--{$smarty.const.LTEXT_LEN}-->文字)</span>
                <br />
                <textarea name="kiyaku_text_vn" maxlength="<!--{$smarty.const.LTEXT_LEN}-->" cols="60" rows="8" class="area60 vn_field" style="<!--{if $arrErr.kiyaku_text_vn != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" ><!--{"\n"}--><!--{$arrForm.kiyaku_text_vn.value|h}--></textarea>
                <span class="attention"> (上限<!--{$smarty.const.LTEXT_LEN}-->文字)</span>
                </td>
            </tr>
        </table>
