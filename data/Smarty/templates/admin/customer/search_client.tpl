...
<form name="form1" id="form1" method="post" action="?">
    ...
    <!--{if $smarty.post.mode == 'search'}-->
        ...
        <table class="list">
            ...
            <!--{section name=cnt loop=$arrClient}-->
            <!--▼会員<!--{$smarty.section.cnt.iteration}-->-->
            <tr>
                <td><!--{$arrClient[cnt].client_id|h}--></td>
                <td><!--{$arrClient[cnt].name|h}--></td>
                <td align="center"><a href="" onclick="return func_submit(<!--{$arrClient[cnt].client_id|h}-->)">決定</a></td>
            </tr>
            <!--▲会員<!--{$smarty.section.cnt.iteration}-->-->
            <!--{sectionelse}-->
            <tr>
