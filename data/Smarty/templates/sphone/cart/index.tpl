...
<section id="undercolumn">
    ...
    <!--{if $smarty.const.USE_POINT !== false}-->
        ...
        <div class="information">
            <p class="fb">仕事の合計金額は「<span class="price"><!--{$tpl_all_total_inctax|n2s}-->円</span>」です。</p>
            ...
            <!--{if $tpl_login}-->
                <p class="point_announce"><span class="user_name"><!--{$tpl_name|h}--> 様</span>の、現在の所持ポイントは「<span class="point"><!--{$tpl_user_point|n2s|default:0}--> pt</span>」です。<br />
                    ポイントは仕事購入時に<span class="price">1pt＝<!--{$smarty.const.POINT_VALUE}-->円</span>として使用することができます。</p>
            <!--{else}-->
    ...
    <div class="form_area">
        ...
        <!--{if count($cartItems) > 0}-->
            ...
            <!--{/foreach}-->
        <!--{else}-->
            <p class="empty"><em>※ 現在カート内に仕事はございません。</em></p>
        <!--{/if}-->
