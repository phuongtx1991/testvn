        ...
        <p>
            <!--{if $isMultiple}-->
                    <!--{foreach item=item from=$shippingItem.shipment_item}-->
                        <em>仕事コード：&nbsp;</em><!--{$item.productsClass.product_code|h}--><br />
                        <em>仕事名：&nbsp;</em>
                ...
                <!--{foreach from=$tpl_arrOrderDetail item=orderDetail}-->
                    <div>
                        ...
                        <div class="cartinContents">
                            <div>
                                <p><em><!--→仕事名--><a<!--{if $orderDetail.enable}--> href="<!--{$smarty.const.P_DETAIL_URLPATH}--><!--{$orderDetail.product_id|u}-->"<!--{/if}--> rel="external"><!--{$orderDetail.product_name|h}--></a><!--←仕事名--></em></p>
                                <p>
                                    <!--→金額-->
