<?php /* Smarty version 2.6.27, created on 2017-11-01 12:41:40
         compiled from products/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/index.tpl', 61, false),array('modifier', 'h', 'products/index.tpl', 74, false),array('modifier', 'sfGetErrorColor', 'products/index.tpl', 74, false),array('modifier', 'strtotime', 'products/index.tpl', 210, false),array('modifier', 'date_format', 'products/index.tpl', 210, false),array('modifier', 'sfNoImageMainList', 'products/index.tpl', 216, false),array('modifier', 'sfTrim', 'products/index.tpl', 235, false),array('modifier', 'count', 'products/index.tpl', 249, false),array('function', 'html_options', 'products/index.tpl', 92, false),array('function', 'html_checkboxes', 'products/index.tpl', 99, false),)), $this); ?>
...
">
                    ...
                    <?php echo smarty_function_html_options(array('options' => ((is_array($_tmp=$this->_tpl_vars['arrCategory'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'selected' => ((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']]['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
...
?>
                        <!--▼求人<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
-->
                        <?php $this->assign('status', ($this->_tpl_vars['arrProducts'][$this->_sections['cnt']['index']]['status'])); ?>
                        <?php if (((is_array($_tmp=$this->_tpl_vars['arrProducts'][$this->_sections['cnt']['index']]['end_date'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != '' && ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrProducts'][$this->_sections['cnt']['index']]['end_date'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('strtotime', true, $_tmp) : strtotime($_tmp)) <= ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=time())) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")))) ? $this->_run_mod_handler('strtotime', true, $_tmp) : strtotime($_tmp))): ?>
                            <?php $this->assign('status', '3'); ?>
                        <?php endif; ?>
...
<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrProducts'][$this->_sections['cnt']['index']]['main_large_image'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfNoImageMainList', true, $_tmp) : SC_Utils_Ex::sfNoImageMainList($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
...
">
                                    <?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrProducts'][$this->_sections['cnt']['index']]['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['category_id'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['category_id']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['status']):
        $this->_foreach['category_id']['iteration']++;
?>
                                        <?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrCategory'][$this->_tpl_vars['status']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfTrim', true, $_tmp) : SC_Utils_Ex::sfTrim($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>

                                        <?php if (! ((is_array($_tmp=($this->_foreach['category_id']['iteration'] == $this->_foreach['category_id']['total']))) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><br /><?php endif; ?>
                                    <?php endforeach; endif; unset($_from); ?>
                                </div>
