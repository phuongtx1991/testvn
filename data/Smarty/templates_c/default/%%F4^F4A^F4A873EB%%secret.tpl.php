<?php /* Smarty version 2.6.27, created on 2017-12-08 17:17:00
...
<div id="window_area">
    ...
    <p class="information">
        ...
        ※Trường hợp quên câu trả lời, vui lòng liên hệ:&nbsp;<a href="mailto:<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrSiteInfo']['email02'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
