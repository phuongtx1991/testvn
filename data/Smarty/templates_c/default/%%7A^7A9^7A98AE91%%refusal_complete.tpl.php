<?php /* Smarty version 2.6.27, created on 2017-11-28 17:24:22
         compiled from /var/www/testvn.hyperion-job.jp/html/../data/Smarty/templates/default/mypage/refusal_complete.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/var/www/testvn.hyperion-job.jp/html/../data/Smarty/templates/default/mypage/refusal_complete.tpl', 26, false),array('modifier', 'h', '/var/www/testvn.hyperion-job.jp/html/../data/Smarty/templates/default/mypage/refusal_complete.tpl', 26, false),array('modifier', 'escape', '/var/www/testvn.hyperion-job.jp/html/../data/Smarty/templates/default/mypage/refusal_complete.tpl', 39, false),)), $this); ?>
    ...
    <div id="mycontents_area">
        ...
        <div id="complete_area">
            <div class="message">退会手続きが完了いたしました。<br />
                <?php echo ((is_array($_tmp=$this->_tpl_vars['arrSiteInfo']['shop_name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
をご利用いただき誠にありがとうございました。<br />
                またのご利用を心よりお待ち申し上げます。
            </div>
