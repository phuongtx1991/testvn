...
class LC_Page_FrontParts_LoginCheck extends LC_Page_Ex
{
    ...
    {
        $objFormParam->addParam('ghi nhớ', 'login_memory', INT_LEN, 'n', array('MAX_LENGTH_CHECK', 'NUM_CHECK'));
        $objFormParam->addParam('địa chỉ email', 'login_email', MTEXT_LEN, 'a', array('EXIST_CHECK', 'MAX_LENGTH_CHECK'));
        $objFormParam->addParam('mật khẩu', 'login_pass', PASSWORD_MAX_LEN, '', array('EXIST_CHECK', 'MAX_LENGTH_CHECK'));
    }
    ...
    public function lfGetErrorMessage($error)
    {
        switch ($error) {
            case TEMP_LOGIN_ERROR:
                $msg = "Email hoặc mật khẩu không chính xác\nNếu bạn chưa đăng ký xong, vui lòng hoàn tất việc đăng ký dựa theo URL đã được gửi vào email đăng ký tạm thời";
                break;
