...
class LC_Page_Error_SystemError extends LC_Page_Error
{
    ...
    public function action()
    {
        ...
        $this->tpl_error = 'Lỗi hệ thống. Vui lòng liên hệ với người phụ trách tra ng web để được tư vấn.';

        if (DEBUG_MODE) {
            echo '<div class="debug">';
            echo '<div>▼▼▼ Sửa lỗi thông tin ở đây ▼▼▼</div>';
            echo '<pre>';
