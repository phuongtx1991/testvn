...
class LC_Page_Admin_Order_ProductSelect extends LC_Page_Admin_Ex
{
    ...
    public function lfInitParam(&$objFormParam)
    {
        ...
        $objFormParam->addParam('求人名', 'search_name', STEXT_LEN, 'KVa', array('MAX_LENGTH_CHECK'));
        $objFormParam->addParam('カテゴリID', 'search_category_id', STEXT_LEN, 'KVa', array('MAX_LENGTH_CHECK', 'SPTAB_CHECK'));
        $objFormParam->addParam('求人コード', 'search_product_code', LTEXT_LEN, 'KVa', array('MAX_LENGTH_CHECK', 'SPTAB_CHECK'));
