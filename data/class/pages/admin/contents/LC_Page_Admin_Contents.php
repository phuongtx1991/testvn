...
class LC_Page_Admin_Contents extends LC_Page_Admin_Ex
{
    ...
    public function lfInitParam(&$objFormParam)
    {
        ...
        $objFormParam->addParam('タイトル_VN', 'news_title_vn', MTEXT_LEN, 'KVa', array('EXIST_CHECK','MAX_LENGTH_CHECK','SPTAB_CHECK'));
        ...
        $objFormParam->addParam('本文_VN', 'news_comment_vn', LTEXT_LEN, 'KVa', array('MAX_LENGTH_CHECK'));
