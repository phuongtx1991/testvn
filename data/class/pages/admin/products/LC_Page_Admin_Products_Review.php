...
class LC_Page_Admin_Products_Review extends LC_Page_Admin_Ex
{
     ...
     * 求人レビューの削除
     *
     * @param  integer $review_id 求人レビューのID
     * @return void
     */
    ...
    public function lfInitParam(&$objFormParam)
    {
        ...
        $objFormParam->addParam('求人名', 'search_name', STEXT_LEN, 'KVas', array('MAX_LENGTH_CHECK'), '', false);
        $objFormParam->addParam('求人コード', 'search_product_code', STEXT_LEN, 'KVas', array('MAX_LENGTH_CHECK'), '', false);
