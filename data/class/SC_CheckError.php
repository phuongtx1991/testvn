...
class SC_CheckError
{
    ...
    public function EXIST_CHECK($value)
    {
        ...
        if (is_array($input_var)) {
            if (count($input_var) == 0) {
                $this->arrErr[$keyname] =
                    "※ Bạn chưa chọn {$disp_name}.<br />";
            }
        } else {
            if (strlen($input_var) == 0) {
                $this->arrErr[$keyname] =
                    "※ Bạn chưa nhập {$disp_name}.<br />";
            }
        }
    }
    ...
    public function SPTAB_CHECK($value)
    {
        ...
        if (strlen($input_var) != 0
            ...
            $this->arrErr[$keyname] = sprintf(
                '※ %s không thể nhập dấu cách, tab, hoặc xuống dòng.<br />',
                $disp_name
            );
        }
    }
    ...
    public function NO_SPTAB($value)
    {
        ...
        if (strlen($input_var) != 0
            ...
            $this->arrErr[$keyname] = sprintf(
                '※ %s Bạn không thể nhập dấu cách, tab, hoặc xuống dòng.<br />',
                $disp_name
            );
        }
    }
    ...
    public function ZERO_START($value)
    {
        ...
        if (strlen($input_var) != 0
            ...
            $this->arrErr[$keyname] =
                "※ Vui lòng không nhập {$disp_name} bắt đầu bằng số 0.<br />";
        }
    }
    ...
    public function EQUAL_CHECK($value)
    {
        ...
        if ($this->arrParam[$keyname1] !== $this->arrParam[$keyname2]) {
            $this->arrErr[$keyname1] =
                "※ {$disp_name1} và {$disp_name2} không thống nhất.<br />";
        }
    }
    ...
    public function GREATER_CHECK($value)
    {
        ...
        if ($input_var1 != ''
            ...
            $this->arrErr[$keyname1] = sprintf(
                '※ Không thể nhập %s có giá trị lớn hơn %s.<br />',
                $disp_name1,
                $disp_name1
            );
        }
    ...
    public function MAX_LENGTH_CHECK($value)
    {
        ...
        if (mb_strlen($this->arrParam[$keyname]) > $max_str_len) {
            $this->arrErr[$keyname] = sprintf(
                '※ Vui lòng nhập %s ít hơn %d chữ cái.<br />',
                $disp_name,
                $max_str_len
            );
        }
    ...
    public function MIN_LENGTH_CHECK($value)
    {
        ...
        if (mb_strlen($this->arrParam[$keyname]) < $min_str_len) {
            $this->arrErr[$keyname] = sprintf(
                '※ Vui lòng nhập %s nhiều hơn %d chữ cái.<br />',
                $disp_name,
                $min_str_len
            );
        }
    ...
    public function NUM_CHECK($value)
    {
        ...
        if ($this->numelicCheck($this->arrParam[$keyname])) {
            $this->arrErr[$keyname] =
                "※ Vui lòng nhập {$disp_name} bằng số.<br />";
        }
    }
    ...
    public function ALPHA_CHECK($value)
    {
        ...
        if (strlen($this->arrParam[$keyname]) > 0
            ...
            $this->arrErr[$keyname] =
                "※ Vui lòng nhập {$disp_name} bằng các ký tự trong alphabet.<br />";
        }
    }
    ...
    public function TEL_CHECK($value)
    {
        ...
        if ($cnt > 0 && $cnt < 3) {
            $this->arrErr[$keyname1] .=
                "※ Vui lòng nhập {$disp_name} vào tất cả các mục.<br />";
        }
        ...
        for ($i = 1; $i <= 3; $i++) {
            ...
            if (strlen($input_var) > 0 && strlen($input_var) > $telItemLen) {
                $this->arrErr[$keyname] .= sprintf(
                    '※ Vui lòng nhập %s trong %d chữ.<br />',
                    $disp_name . $i,
                    $telItemLen
                );
            } elseif ($this->numelicCheck($input_var)) {
                $this->arrErr[$keyname] .=
                    "※ Vui lòng nhập {$disp_name}{$i} bằng số.<br />";
            }
        ...
        if ($total_count > $telLen) {
            $this->arrErr[$keyname3] .=
                "※ Vui lòng nhập {$disp_name} trong khoảng {$telLen} chữ.<br />";
        }
    }
    ...
    */
    public function FULL_EXIST_CHECK($value)
    {
        ...
        if ($blank) {
            $this->arrErr[$keyname] =
                "※ Vui lòng nhập nhập {$disp_name}.<br />";
        }
    }
    ...
    */
    public function TOP_EXIST_CHECK($value)
    {
        ...
        if ($error) {
            $this->arrErr[$keyname] =
                "※ Vui lòng nhập {$disp_name} theo thứ tự từ trên xuống dưới.<br />";
        }
    }
    ...
    public function KANA_CHECK($value)
    {
        ...
        if (strlen($input_var) > 0 && !preg_match($pattern, $input_var)) {
            $this->arrErr[$keyname] =
                "※ Vui lòng nhập {$disp_name} bằng Katakana.s<br />";
        }
    }
    ...
    public function KANABLANK_CHECK($value)
    {
        ...
        if (strlen($input_var) > 0 && !preg_match($pattern, $input_var)) {
            $this->arrErr[$keyname] =
                "※ Vui lòng nhập {$disp_name} bằng Katakana.<br />";
        }
    }
    ...
    public function ALNUM_CHECK($value)
    {
        ...
        if (strlen($input_var) > 0 && !ctype_alnum($input_var)) {
            $this->arrErr[$keyname] =
                "※ Vui lòng nhập {$disp_name} bằng số trong bảng alphabet.<br />";
        }
    }
    ...
    public function GRAPH_CHECK($value)
    {
        ...
        if (strlen($input_var) > 0 && !preg_match($pattern, $input_var)) {
            $this->arrErr[$keyname] =
                "※ Vui lòng nhập {$disp_name} bằng ký tự chữ số trong bảng alphabet.<br />";
        }
    }
    ...
    public function ZERO_CHECK($value)
    {
        ...
        if ($this->arrParam[$keyname] == '0') {
            $this->arrErr[$keyname] =
                "※ Vui lòng nhập {$disp_name} lớn hơn 1.<br />";
        }
    }
    ...
    public function NUM_RANGE_CHECK($value)
    {
        ...
        if (($count > 0) && $min_digit > $count || $max_digit < $count) {
            $this->arrErr[$keyname] = sprintf(
                '※ Vui lòng nhập %s trong khoảng %d chữ số ~ %d chữ số<br />',
                $disp_name,
                $min_digit,
                $max_digit
            );
    ...
    public function NUM_COUNT_CHECK($value)
    {
        ...
        if (($count > 0) && $count != $digit) {
            $this->arrErr[$keyname] =
                "※ Vui lòng nhập {$disp_name} bằng {$digit} chữ số.<br />";
        }
    }
    ...
    public function EMAIL_CHECK($value)
    {
        ...
        if (!preg_match($regexp, $this->arrParam[$keyname])) {
            $this->arrErr[$keyname] = "※ Định dạng {$disp_name} chưa đúng.<br />";
    ...
    public function EMAIL_CHAR_CHECK($value)
    {
        ...
        if (strlen($input_var) > 0 && !preg_match($pattern, $input_var)) {
            $this->arrErr[$keyname] =
                "※ Vui lòng nhập chính xác các ký tự trong {$disp_name}.<br />";
        }
    }
    ...
    public function URL_CHECK($value)
    {
        ...
        if (strlen($input_var) > 0 && !preg_match($pattern, $input_var)) {
            $this->arrErr[$keyname] =
                "※ Vui lòng nhập chính xác {$disp_name}.<br />";
        }
    }
        ...
        if (!empty($params)) {
            ...
            foreach ($params as $param) {
                ...
                if (long2ip(ip2long($param)) != trim($param) && !empty($param)) {
                    $this->arrErr[$keyname] =
                        "※ Vui lòng nhập chính xác địa chỉ IP cho {$disp_name}.<br />";
                }
            }
        }
    }
    ...
    public function FILE_EXT_CHECK($value)
    {
        ...
        if ($match === false) {
            ...
            $this->arrErr[$keyname] =
                "※ Định dạng {$disp_name} là {$str_ext}.<br />";
        }
    }
    ...
    public function FIND_FILE($value)
    {
        ...
        if ($this->arrParam[$keyname] != '' && !file_exists($path)) {
            $this->arrErr[$keyname] = "※ Không tìm thấy {$path}.<br />";
        }
    }
    ...
    public function FILE_SIZE_CHECK($value)
    {
        ...
        if ($_FILES[$keyname]['size'] > $max_file_size *  1024) {
            ...
            $this->arrErr[$keyname] = sprintf(
                '※ Vui lòng sử dụng file %s có kích thước dưới %d%s.<br />',
                $disp_name,
                $max_file_size,
                $byte
            );
    ...
    public function FILE_NAME_CHECK($value)
    {
        ...
        if (strlen($filename) > 0 && !preg_match($pattern, $filename)) {
            $this->arrErr[$keyname] =
                "※ Vui lòng chỉ sử dụng kí hiệu （_ - .）, số trong bảng alphabet để đặt tên file {$disp_name}.<br />";
        }
    }
    ...
    public function CHECK_BIRTHDAY($value)
    {
        ...
        if (strlen($this->arrParam[$keyname]) >= 1) {
            // 年の数字チェック、最小数値制限チェック
            $this->doFunc(array("{$disp_name}(Năm)", $keyname, BIRTH_YEAR),
            ...
            $this->doFunc(array("{$disp_name}(Năm)", $keyname, $current_year),
                array('MAX_CHECK'));
            // 上のチェックでエラーある場合、中断する。
            if (isset($this->arrErr[$keyname])) {
                return;
    ...
    public function CHECK_SET_TERM($value)
    {
        ...
        if ((strlen($start_year) > 0 && strlen($start_month) > 0 && strlen($start_day) > 0)
            ...
            if (($this->arrErr[$keyname1] == '' && $this->arrErr[$keyname2] == '') && $date1 > $date2) {
                $this->arrErr[$keyname1] =
                    "※ Thời gian của {$disp_name1} và {$disp_name2} không đúng.<br />";
            }
        }
    }
    ...
    public function DOMAIN_CHECK($value)
    {
        ...
        $pattern = "/^\.[^.]+\..+/i";
        if (strlen($input_var) > 0 && !preg_match($pattern, $input_var)) {
            $this->arrErr[$keyname] = "※ Định dạng {$disp_name} không đúng.<br />";
        }
    }
    ...
    public function MOBILE_EMAIL_CHECK($value)
    {
        ...
        if (strlen($input_var) > 0
            ...
            $this->arrErr[$keyname] =
                "※ {$disp_name} không phải số điện thoại di dộng.<br />";
        }
    }
    ...
    public function CHECK_REGIST_CUSTOMER_EMAIL($value)
    {
        ...
        switch ($register_user_flg) {
            case 1:
                $this->arrErr[$keyname] .=
                    "※ {$disp_name} đã được sử dụng để đăng ký thành viên.<br />";
                break;
            case 2:
                $this->arrErr[$keyname] .=
                    "※ Sau khi xóa tài khoản, bạn không thể sử dụng {$disp_name} này trong thời gian quy định.<br />";
                break;
            default:
                break;
        }
    ...
    public function EVAL_CHECK($value)
    {
        ...
        if ($this->evalCheck($input_var) === false) {
            $this->arrErr[$keyname] =
                "※ Định dạng {$disp_name} không đúng.<br />";
        }
    }
            ...
            if ($val_key != 0 && (is_string($key) || is_int($key))) {
                if (!is_numeric($key) && preg_match('/^[a-z0-9_]+$/i', $key)) {
                    ...
                    if (strlen($this->arrParam[$key]) > 0
                        ...
                        $this->arrErr[$value[1]] = '※ ' . $value[0] . ' có chứa các ký tự/chữ bị cấm.<br />';
                    }
