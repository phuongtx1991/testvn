...
//    function LC_Page_User_action_after($objPage) {
//
//        if ($objPage->getMode() == 'cart') {
//            // プロダクトIDの正当性チェック
//            $product_id = self::CheckProductId($_POST['product_id']);
//
//            if ($product_id) {
//                // 商品閲覧履歴取得（最近見た商品）
...
//    }
//
//    function LC_Page_Products_List_action_after($objPage) {
//
//        if ($objPage->getMode() == 'cart') {
//            // プロダクトIDの正当性チェック
//            $product_id = self::CheckProductId($_POST['product_id']);
...
//    }
    ...
    function addCookie($pid) {
        $product_id = self::CheckProductId($pid);
        if ($product_id) {
            // 商品閲覧履歴取得（最近見た商品）
            self::setItemHistory($product_id);
        }
    ...
    function setCookie($product_id) {
        ...
        $_COOKIE[$key] = $strParam;
    }

    function delCookie($product_id) {
        $plgInfo = self::getPlgInfo();
